...
<footer class="text-center bg-gradient-to-tl from-green-400 to-indigo-800 text-white ">
  ...
  <div class="text-center bg-gradient-to-tl from-green-400 to-indigo-800 p-4" >
    © 2022 Copyright:
